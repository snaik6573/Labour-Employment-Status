...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Welcome - <?php echo $_SESSION['setting_name'] ?> | <a href="#" target="_blank">Recruitment Management System</a></div></div>
        </footer>
